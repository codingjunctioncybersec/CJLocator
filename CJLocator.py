...
"""
    ...
    utils.print(f'{G}[>] {C}Created By : {W}Coding Junction')
    utils.print(f'{G} |---> {C}YouTube : {W}youtube.com/@CodingJunctionOfficial')
    utils.print(f'{G} |---> {C}Instagram : {W}instagram.com/codingjunction.official')
